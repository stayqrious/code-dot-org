Sequel.migration do
  ...
  up {
  	#run 'ALTER TABLE contact_rollups MODIFY email VARCHAR(255) COLLATE utf8_bin'
  }
  down {
  	#run 'ALTER TABLE contact_rollups MODIFY email VARCHAR(255) COLLATE utf8_general_ci'
  }
end
